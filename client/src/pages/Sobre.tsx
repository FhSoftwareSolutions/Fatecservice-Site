    ...
    <>
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-brand-dark to-[#192e46] relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sobre <span className="text-brand-primary">Nós</span>
          </h1>
          <p className="text-brand-gray text-lg mb-8 max-w-3xl mx-auto">
            Conheça a história, os valores e a equipe por trás da FH Software
            Solutions
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-brand-gray">
                <p>
                  A FH Software Solutions é uma empresa criada a partir de um
                  grupo de amigos de faculdade do Big Data na Fatec Sunji
                  Nishimura e surgiu a partir da ideia de criar soluções
                  tecnologicas e serviços em 2025.
                </p>
                <p>
                  Nosso objetivo é oferecer serviços de desenvolvimento web,
                  automação de fluxos, desenvolvimento low-code, IoT e análise
                  de dados, integrando tecnologias modernas com soluções
                  práticas e eficientes.
                </p>
                <p>
                  Contamos com uma equipe especializada de 6 profissionais
                  dedicados, trabalhando de forma colaborativa para transformar
                  ideias em soluções digitais inovadoras que impulsionam o
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-brand-dark to-brand-darker relative">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-6">
              Missão, Visão e{" "}
              <span className="text-brand-primary">Valores</span>
            </h2>
            <p className="text-brand-gray max-w-2xl mx-auto">
              Os princípios cristãos que guiam nosso trabalho e nossa relação
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#182b3e] rounded-xl p-8 shadow-lg highlight-card">
              ...
              <p className="text-brand-gray">
                Desenvolver soluções tecnológicas que transformem positivamente
                a vida das pessoas, servindo com excelência, integridade e
                respeito ao próximo, refletindo o amor e a dedicação que nos
                foram ensinados pelos valores cristãos.
              </p>
            </div>
            ...
            <div className="bg-[#182b3e] rounded-xl p-8 shadow-lg highlight-card">
              ...
              <p className="text-brand-gray">
                Ser reconhecida como uma empresa que integra excelência técnica
                e valores cristãos na criação de soluções digitais, contribuindo
                para um mundo mais justo e acessível através da tecnologia e
                inspirando outros a seguirem o mesmo caminho.
              </p>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-6">
              Nossa <span className="text-brand-primary">Equipe</span>
            </h2>
            <p className="text-brand-gray max-w-2xl mx-auto">
              Conheça os profissionais apaixonados por tecnologia que fazem
              parte da FH Software Solutions
            </p>
            <div className="w-20 h-1 bg-brand-secondary mx-auto mt-6"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              <div className="relative">
                <img
                  src="/src/assets/imagens/mateus-robers.png"
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em desenvolvimento web e soluções low-code com
                  foco em usabilidade e experiência do usuário.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
                    className="text-brand-gray hover:text-brand-secondary transition-colors"
                  >
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              <div className="relative">
                <img
                  src="/src/assets/imagens/jonah.png"
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-primary mb-4">
                  Automatic Workflows/Low-code
                </p>
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em automação de processos e desenvolvimento de
                  fluxos usando ferramentas low-code.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              <div className="relative">
                <img
                  src="/src/assets/imagens/luis.png"
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em soluções de Internet das Coisas, conectividade
                  e automação de dispositivos.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              <div className="relative">
                <img
                  src="/src/assets/imagens/cadete.png"
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em desenvolvimento front-end e automação de
                  fluxos com foco em experiência do usuário.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em engenharia de prompts, Vibe-code e análise de
                  dados para soluções inovadoras.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
            ...
            <div className="bg-[#182b3e] rounded-xl overflow-hidden shadow-lg hover-lift group">
              ...
              <div className="p-6 relative -mt-16">
                ...
                <p className="text-brand-gray text-sm mb-4">
                  Especialista em desenvolvimento de interfaces e experiências
                  de usuário com foco em usabilidade e design.
                </p>
                <div className="flex space-x-2">
                  <a
                    href="#"
